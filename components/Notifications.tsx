      ...
      <PopoverContent align="end" className="shad-popover">
        ...
        >
          <InboxNotificationList>
            {unreadNotifications.length <= 0 && <p className="py-2 text-center text-dark-500">No notifications yet</p>}
            ...
            {unreadNotifications.length > 0 &&
              unreadNotifications.map((inboxNotification: any) => (
                <InboxNotification
                  ...
                  showActions={false}
                  kinds={{
                    thread: (props) => <InboxNotification.Thread {...props} showRoomName={false} showActions={false} />,
                    textMention: (props) => {
                        ...
                        <InboxNotification.Custom
                          ...
                          aside={
                            <InboxNotification.Icon className="bg-transparent">
                              <Image src={(avatar as string) || ""} width={36} height={36} alt="avatar" className="rounded-full" />
